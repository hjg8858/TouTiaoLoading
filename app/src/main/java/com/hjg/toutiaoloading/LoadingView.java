package com.hjg.toutiaoloading;
...
public class LoadingView extends FrameLayout {
    ...
    private void initAnimation() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            loadAnimator.setStartDelay(100 * i);//延迟
            loadAnimator.setRepeatMode(ObjectAnimator.REVERSE);//循环模式倒序播放
            loadAnimator.setRepeatCount(-1);//循环次数
